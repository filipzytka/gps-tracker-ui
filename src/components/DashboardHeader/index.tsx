...
const DashboardHeader = (props: {
  ...
  return (
    <header className="sticky top-0 flex w-full z-9999 bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-grow items-center justify-end px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        ...
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          <button
            ...
            className="ms-8 block rounded-sm border border-stroke bg-white p-1.5 shadow-sm dark:border-strokedark dark:bg-boxdark lg:hidden"
          >
